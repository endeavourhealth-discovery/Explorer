...
public class ExplorerJDBCDAL extends BaseJDBCDAL {
    ...
    public PatientResult getPatientResult(Integer page, Integer size, String name, String legendName, String seriesName) throws Exception {
        ...
        if (name.equals("")) { // No name
            ...
            try (PreparedStatement statement = conn.prepareStatement(sql)) {
                statement.setString(1, legendName);
