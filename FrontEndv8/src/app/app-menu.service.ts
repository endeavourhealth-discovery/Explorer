...
export class AppMenuService implements  AbstractMenuProvider {
  static getRoutes(): Routes {
    return [
      ...
      {path: 'covid_deceased', component: DashboardComponent, data: {role: 'explorer', chartType: 'covid_deceased'}},
  ...
  getMenuOptions(): MenuOption[] {
    return [
      ...
      {icon: 'fas fa-user-friends', caption: 'Covid Age Deceased Dashboard', state: 'covid_deceased'},
