...
('observation','getConceptName(episodicity_concept_id)', 'Episodicity Concept Name'),
...
('medication_statement','getConceptName(authorisation_type_concept_id)', 'Authorisation Type Concept Name'),
