...
('observation','getConceptName(t.non_core_concept_id)', 'Concept term (i.e. Asthma, Systolic BP)'),
('observation','getConceptCode(t.non_core_concept_id)', 'Concept code (original code)'),
...
('observation','t.is_review', 'Is review (i.e. problem review)'),
('observation','t.problem_end_date', 'Problem end date'),
('observation','t.age_at_event', 'Age of patient at event'),
('observation','getConceptName(t.episodicity_concept_id)', 'Episode (i.e. FIRST, NEW)'),
('observation','t.is_primary', 'Is primary (i.e. Primary diagnosis)'),
