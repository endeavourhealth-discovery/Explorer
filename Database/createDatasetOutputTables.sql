...
('patient', 'get_concept_name(gender_concept_id)', 'Gender Concept Name'),
...
('patient', 'get_concept_name(ethnic_code_concept_id)', 'Ethnic Concept Name'),
...
('observation','get_concept_name(date_precision_concept_id)', 'Date Precision Name'),
...
('observation','get_concept_name(result_concept_id)', 'Result Concept Name'),
...
('observation','get_concept_name(core_concept_id)', 'Core Concept Name'),
('observation','non_core_concept_id', 'Non Core Concept ID'),
('observation','get_concept_name(non_core_concept_id)', 'Non Core Concept Name'),
('observation','age_at_event', 'Age At Event'),
('observation','episodicity_concept_id', 'Episodicity Concept Code'),
('observation','get_concept_name(episodicity_concept_id)', 'Episodicity Concept Code'),
...
('medication_statement','get_concept_name(date_precision_concept_id)', 'Date Precision Concept Name'),
...
('medication_statement','get_concept_name(authorisation_type_concept_id)', 'Authorisation Type Concept Code'),
('medication_statement','core_concept_id', 'Core Concept Code'),
('medication_statement','get_concept_name(core_concept_id)', 'Core Concept Name'),
('medication_statement','non_core_concept_id', 'Non Vore Concept Code'),
('medication_statement','get_concept_name(non_core_concept_id)', 'Non Vore Concept Name'),
...
('encounter','get_concept_name(date_precision_concept_id)', 'Date Precision Concept Name' ),
...
('encounter','get_concept_name(core_concept_id)', 'Core Concept Name'),
('encounter','non_core_concept_id', 'Non Core Concept Code'),
('encounter','get_concept_name(non_core_concept_id)', 'Non Core Concept Name'),
