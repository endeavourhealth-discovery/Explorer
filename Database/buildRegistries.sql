...
BEGIN
  ...
  ELSE
          ...
          FROM qry_reg q LEFT JOIN population_denominators pls ON q.ods_code = pls.practice_ods_code GROUP BY registry_name, query, q.ccg, q.registered_practice, q.ods_code, q.registry_size, now(), parentregistry, targetPercentage;
  END IF;
