...
BEGIN
   ...
   SET @sql = CONCAT('CREATE TABLE ', p_observationtab, ' AS SELECT id, patient_id, person_id, clinical_effective_date, result_value, non_core_concept_id, organization_id 
   ...
   WHILE EXISTS (SELECT row_id from qry_tmp WHERE row_id > @row_id AND row_id <= @row_id + 10000) DO
     ...
     SELECT o.id, o.patient_id, o.person_id, o.clinical_effective_date, o.result_value, o.non_core_concept_id, o.organization_id FROM ", p_schema,".observation o 
