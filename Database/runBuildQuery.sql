...
ELSEIF p_queryType = '3' THEN  
   ...
   IF p_incDiagnosisConceptTab IS NOT NULL THEN 
      ...
      CALL filterObservationByEarliestLatest(p_incDiagnosisConceptTab, 'qry_tmp_2', p_diagnosis_tmp, 'Earliest', NULL, NULL, '1');
      ...
      SELECT o.id, 
             ...
             o.organization_id,
             o.value_set_code_type 
      FROM qry_tmp_1 o JOIN ', p_queryCohort,' p ON p.patient_id = o.patient_id AND p.organization_id = o.organization_id 
      JOIN ', p_diagnosis_tmp,' o1 ON o1.patient_id = p.patient_id AND o1.organization_id = p.organization_id 
